...
Designing the system on a high level first provides two advantages: the design will be very thoroughly documented, and it will also be easy to begin implementation as I will have a strong starting point. Also, as I am basing my design heavily on the RP2040, I can draw upon diagrams such as Figures \ref{fig:pio-block} and \ref{fig:pio-sm} to inform the design.
...
Once the block design and project skeleton are down, I intend to implement modules starting with the simpler ones such as clock dividers and FIFOs, before moving on to more complex bits such as pin mapping, instruction decoders and execution engines.
