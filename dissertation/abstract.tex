\begin{abstract}
    ...
    We find our PIO implementation to be capable of implementing common standard protocols such as SPI, as well as non-standard interfaces such as WS2812B serial. When implemented in a Xilinx Artix 7 device, up to an order of magnitude more FPGA resources are utilised by PIO than sample full-featured single purpose I/O interface hardware. Despite it's high utilisation relative to fixed interfaces, it is still considered small when included as part of a larger SoC design, and has the advantage of being far more versatile.
