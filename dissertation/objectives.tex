...
A secondary objective of the implementation of the PIO device is to contribute back to the the open source hardware and Chisel community by providing an open source implementation of PIO and the PIO assembly language. The project is worked on and documented in a public GitHub repository\footnote{\url{https://github.com/Joeyh021/riscv-pio}} where it shall remain after the completion of the project for others to use within their own SoC designs.
