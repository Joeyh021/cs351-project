...
A number of software tools and hardware resources were utilised to make this project possible.
...
The Chisel libraries were included in the project via definitions in sbt's \txt{build.sbt} file. Chisel is also published on GitHub under the Apache License 2.0, and build artifacts are available on Maven Central fo

Open source JDK builds were used, both on Linux and MacOS.
